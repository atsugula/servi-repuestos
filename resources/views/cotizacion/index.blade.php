                                ...
                                <tbody>
                                    @forelse ($cotizaciones as $venta)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('cotizaciones.destroy',$venta->id) }}" method="POST" class="form-delete">
                                                    <a class="btn btn-sm btn-primary" target="_blank" href="{{ route('cotizaciones.recibo',$venta->id) }}"><i class="fa fa-file"></i></a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('cotizaciones.edit',$venta->id) }}"><i class="fa fa-fw fa-edit"></i></a>
                                                    @csrf
                                                    @method('DELETE')
